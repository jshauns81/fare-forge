...
const UNIT_ALIASES = new Map(Object.entries({
  ...
  'fluid ounce': 'fl oz', 'fluid ounces': 'fl oz', 'fluid oz': 'fl oz', 'fl oz': 'fl oz', 'fl ounce': 'fl oz', 'fl ounces': 'fl oz', floz: 'fl oz',
...
function takeUnit(s) {
  // The optional second token catches two-word volumes: "fl oz", "fluid ounces".
  const m = s.trim().match(/^([a-zA-Z.]+(?:\s+(?:ounces?|oz))?)\s+/);
